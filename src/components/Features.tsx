...
export function Features() {
  ...
  return (
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto -mt-20">
      <div className="px-8">
  ...
  <div className="relative flex py-8 px-2 gap-10 h-full">
    <div className="w-full p-5 mx-auto bg-white dark:bg-neutral-900 shadow-2xl group h-full">
      <div className="flex flex-1 w-full h-full flex-col space-y-2">
        <img src="/heroimage.png" alt="header" width={800} height={800} className="h-full w-full aspect-square object-cover rounded-sm" />
      </div>
    </div>
...
export const SkeletonThree = () => (
  <a href="https://www.youtube.com/watch?v=RPa3_AD1_Vs" target="_blank" rel="noopener noreferrer" className="relative flex gap-10 h-full group/image">
...
export const SkeletonTwo = () => {
  const images = [
    ...
    "https://images.pexels.com/photos/2330137/pexels-photo-2330137.jpeg?auto=compress&cs=tinysrgb&w=600",
        ...
        {images.map((img, idx) => (
          <motion.div
            ...
            <div className="rounded-xl -mr-4 mt-4 p-1 bg-white dark:bg-neutral-800 border dark:border-neutral-700 border-neutral-100">
              <img src={img} alt="bali" className="rounded-lg h-20 md:h-40 object-cover" />
            </div>
          </motion.div>
        ))}
      </div>
